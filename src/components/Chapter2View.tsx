...
export const Chapter2View: React.FC<Chapter2ViewProps> = ({
  ...
  const handleOpenVisualResource = (type: 'notebook' | 'synthesis') => {
    ...
    setTimeout(() => {
      const targetId = type === 'notebook' ? 'infografia-visual-cap2' : 'sintesis-conceptos-cap2';
    ...
    <div className="space-y-12 max-w-4xl mx-auto animate-fade-in">
      ...
      <div className="bg-[#141414] border border-[#262626] rounded-3xl p-8 sm:p-10 relative overflow-hidden shadow-2xl space-y-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-mono text-slate-400">{chapter2Header.pages}</span>
        </div>
      ...
      {/* Chapter 2 Visual Resource Section (renders strictly one at a time, never sequentially) */}
      <ChapterVisualSection
        chapterId="cap2"
        chapterNumber="Capítulo 2"
        notebookData={notebookInfographics.cap2}
        synthesisData={chapterInfographics.cap2}
      ...
      <section id="notas-cap2" className="bg-[#141414] border border-[#262626] rounded-2xl p-6 sm:p-8 space-y-6 shadow-xl scroll-mt-24">
        <div className="flex items-center justify-between border-b border-[#262626] pb-4 flex-wrap gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl sm:text-2xl font-serif font-bold text-white">Notas del Capítulo 2 (11 a 33)</h2>
