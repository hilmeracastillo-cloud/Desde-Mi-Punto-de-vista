...
export const Chapter7View: React.FC<Chapter7ViewProps> = ({
  ...
  return (
    <div className="space-y-12 max-w-4xl mx-auto animate-fade-in">
      ...
      {/* Chapter 7 Visual Infographic - NotebookLM Style */}
      {notebookInfographics.cap7 && (
        <NotebookLMInfographic
          data={notebookInfographics.cap7}
          onOpenModal={onOpenNotebookInfographicModal}
        />
      )}

      {/* Chapter 7 Concept Synthesis - Structured Analytical Schema */}
      {chapterInfographics.cap7 && (
        <ChapterInfographic
          data={chapterInfographics.cap7}
