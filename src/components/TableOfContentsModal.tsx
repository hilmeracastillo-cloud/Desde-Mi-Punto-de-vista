      ...
      <div className="relative w-full max-w-xl h-full bg-[#0D0D0D] border-l border-[#262626] shadow-2xl flex flex-col z-10 overflow-hidden text-slate-200">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 font-sans">
          ...
          <div className="space-y-3">
            ...
            >
              <div>
                <div className="text-sm font-bold font-serif">El liderazgo como disciplina de diseño</div>
                <div className="text-xs text-slate-400 font-sans mt-0.5">Arquitectos antes que administradores: dimensiones, principios y prueba definitiva del liderazgo.</div>
              </div>
              <ChevronRight className={`w-4 h-4 shrink-0 transition-transform ${activeView === "cap5" ? "text-indigo-400 translate-x-0.5" : "text-slate-500 group-hover:translate-x-0.5"}`} />
            </button>
            ...
            <div className="pl-3 border-l-2 border-[#262626] space-y-1.5 pt-1">
              {chapter5Sections.map((sec) => (
                <button
                  key={sec.id}
                  onClick={() => handleNavigate("cap5", sec.id)}
                  className="w-full text-left py-1.5 px-2.5 rounded-lg text-xs text-slate-400 hover:text-indigo-300 hover:bg-[#18181C] transition-all flex items-center justify-between group cursor-pointer"
                >
                  <span className="truncate pr-2">• {sec.title}</span>
                  <ChevronRight className="w-3 h-3 opacity-0 group-hover:opacity-100 text-indigo-400 shrink-0 transition-opacity" />
              ...
              <button
                ...
                className="w-full text-left py-1.5 px-2.5 rounded-lg text-xs text-indigo-400 hover:text-indigo-300 hover:bg-[#18181C] transition-all font-mono flex items-center justify-between cursor-pointer"
              >
                <span>• Referencias del Capítulo 5</span>
              </button>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            >
              <div>
                <div className="text-sm font-bold font-serif">La organización que aprende de sí misma</div>
                <div className="text-xs text-slate-400 font-sans mt-0.5">Mecanismos de reflexión, rediseño y desarrollo de capacidades.</div>
              </div>
              <ChevronRight className={`w-4 h-4 shrink-0 transition-transform ${activeView === "cap6" ? "text-indigo-400 translate-x-0.5" : "text-slate-500 group-hover:translate-x-0.5"}`} />
            </button>
            ...
            <div className="pl-3 border-l-2 border-[#262626] space-y-1.5 pt-1">
              {chapter6Sections.map((sec) => (
                <button
                  key={sec.id}
                  onClick={() => handleNavigate("cap6", sec.id)}
                  className="w-full text-left py-1.5 px-2.5 rounded-lg text-xs text-slate-400 hover:text-indigo-300 hover:bg-[#18181C] transition-all flex items-center justify-between group cursor-pointer"
                >
                  <span className="truncate pr-2">• {sec.title}</span>
                  <ChevronRight className="w-3 h-3 opacity-0 group-hover:opacity-100 text-indigo-400 shrink-0 transition-opacity" />
              ...
              <button
                ...
                className="w-full text-left py-1.5 px-2.5 rounded-lg text-xs text-indigo-400 hover:text-indigo-300 hover:bg-[#18181C] transition-all font-mono flex items-center justify-between cursor-pointer"
              >
                <span>• Referencias del Capítulo 6</span>
              </button>
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="pl-3 border-l-2 border-[#262626] space-y-1.5 pt-1">
              {chapter7Sections.map((sec) => (
                <button
                  key={sec.id}
                  onClick={() => handleNavigate("cap7", sec.id)}
                  className="w-full text-left py-1.5 px-2.5 rounded-lg text-xs text-slate-400 hover:text-indigo-300 hover:bg-[#18181C] transition-all flex items-center justify-between group cursor-pointer"
                >
                  <span className="truncate pr-2">• {sec.title}</span>
                  <ChevronRight className="w-3 h-3 opacity-0 group-hover:opacity-100 text-indigo-400 shrink-0 transition-opacity" />
