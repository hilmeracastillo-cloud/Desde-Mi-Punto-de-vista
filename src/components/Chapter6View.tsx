...
export const Chapter6View: React.FC<Chapter6ViewProps> = ({
  ...
  const handleOpenVisualResource = (type: 'notebook' | 'synthesis') => {
    ...
    setTimeout(() => {
      const targetId = type === 'notebook' ? 'infografia-visual-cap6' : 'sintesis-conceptos-cap6';
  ...
  return (
    <div className="space-y-12 max-w-4xl mx-auto animate-fade-in">
      ...
      {/* Chapter 6 Visual Resource Section (renders strictly one at a time, never sequentially) */}
      <ChapterVisualSection
        chapterId="cap6"
        chapterNumber="Capítulo 6"
        notebookData={notebookInfographics.cap6}
        synthesisData={chapterInfographics.cap6}
      ...
      <div id="notas-cap6" className="bg-[#141414] border border-[#262626] rounded-2xl p-6 sm:p-8 space-y-6 shadow-xl scroll-mt-24">
        <div className="flex items-center justify-between border-b border-[#262626] pb-4 flex-wrap gap-3">
          <div className="flex items-center gap-3">
            <Bookmark className="w-5 h-5 text-indigo-400" />
            <div>
              <h2 className="text-xl sm:text-2xl font-serif font-bold text-white">Notas del Capítulo 6 (77 a 90)</h2>
