...
export const chapter2Footnotes: Footnote[] = [
  {
    ...
    description: "La consolidación de los sistemas nacionales de educación durante el siglo XIX estuvo estrechamente relacionada con la formación del Estado moderno. Prusia constituye uno de los casos históricos más importantes por el desarrollo de estructuras administrativas centralizadas, formación sistemática del profesorado, organización curricular y mecanismos de supervisión capaces de extender la escolarización a poblaciones cada vez mayores.\n\nEs importante evitar una simplificación frecuente: la escuela contemporánea no puede describirse rigurosamente como una reproducción directa de un único «modelo prusiano». La formación de los sistemas educativos nacionales fue un proceso histórico más complejo, con diferencias significativas entre Prusia, Francia, Inglaterra y Estados Unidos. Andy Green documenta precisamente esta relación entre educación, formación estatal y construcción de sistemas nacionales. (Springer)\n\nPara la Arquitectura del Aprendizaje, el interés de este proceso consiste en reconocer que estructuras que hoy parecen naturales —administración, currículo común, organización institucional y escolarización masiva— fueron originalmente respuestas de diseño a necesidades históricas concretas.",
    readings: ["Andy Green (1990)"],
    links: [
  ...
  },
  {
    ...
    description: "La industrialización transformó profundamente la organización económica y social de Europa. Urbanización, expansión productiva, desarrollo tecnológico y transformación de las instituciones modificaron las capacidades que las sociedades necesitaban desarrollar y las condiciones bajo las cuales podían extender la educación.\n\nSin embargo, sería históricamente impreciso afirmar que la escuela moderna fue creada simplemente para producir trabajadores para las fábricas. La escolarización masiva estuvo vinculada también con alfabetización, ciudadanía, construcción nacional, administración estatal y transformaciones sociales más amplias.\n\nDavid Landes documenta la magnitud de los cambios tecnológicos, económicos y sociales asociados con la Revolución Industrial europea. (Cambridge University Press)\n\nDesde la Arquitectura del Aprendizaje, este contexto ayuda a comprender una cuestión fundamental: una arquitectura institucional puede ser extraordinariamente eficaz para resolver los problemas de la época en que fue creada y, sin embargo, necesitar ser rediseñada cuando cambian radicalmente las condiciones del entorno.",
    readings: ["David S. Landes (2003)"],
    links: [
